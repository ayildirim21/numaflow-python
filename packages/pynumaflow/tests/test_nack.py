...
class TestNackOptions:
    ...
    def test_with_values(self):
        opts = NackOptions(delay=5000, max_deliveries=3, reason="downstream down")
...
class TestToProto:
    ...
    def test_to_proto_maps_all_fields(self):
        proto = NackOptions(delay=5000, max_deliveries=3, reason="retry")._to_proto()
...
class TestFromProto:
    ...
    def test_set_fields_are_returned(self):
        proto = nack_options_pb2.NackOptions(delay=5000, max_deliveries=3, reason="retry")
...
class TestRoundTrip:
    ...
    def test_round_trip_full(self):
        original = NackOptions(delay=5000, max_deliveries=3, reason="retry")
